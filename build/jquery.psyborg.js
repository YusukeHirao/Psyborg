                    ...
                    for (; i < l; i++) {
                        ...
                        if (this.repeat === PsycleRepeat.LOOP) {
                            ...
                            for (; i2 < l2; i2++) {
                                ...
                                cloneBefore.show();
                                cloneBefore.$el.css({ left: this.panelWidth * (i - this.length) - (this.stageWidth * i2) });
                                cloneBefore.$el.addClass('__BEFORE__');
                                // if (i2 !== 1) {
                                // 	cloneAfter = panel.clone();
                                // 	cloneAfter.show();
                                // 	cloneAfter.$el.css({ left:<number> this.panelWidth * (i - this.length) * -1 + (this.stageWidth * i2)});
