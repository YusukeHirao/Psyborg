...
;
  ...
  Psyborg = (function() {
    var getBackgroundColor, getBackgroundImage, getPositionState, multiMatrix3x3;
    ...
    Psyborg.prototype._skewX = 0;

    Psyborg.prototype._skewY = 0;
    ...
    Psyborg.prototype.skewX = function(val, setRelative) {
      var setValue;
      ...
      if (val == null) {
        ...
        this._skewX = setValue;
        this.update();
        return this;
      }
    };

    Psyborg.prototype.skewY = function(val, setRelative) {
      var setValue;
    ...
    Psyborg.prototype.src = function(src) {
