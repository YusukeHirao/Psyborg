...
(function (psyborg) {
    ...
    var EventDispacther = (function () {
        function EventDispacther() {
            this._listeners = {};
        }
        EventDispacther.prototype.on = function (types, listener) {
        ...
        EventDispacther.prototype.off = function (types, listener) {
            var typeList = types.split(/\s+/);
            var i = 0;
            var l = typeList.length;
            var type;
        ...
        EventDispacther.prototype.trigger = function (type, data, context) {
        ...
        return EventDispacther;
    })();
    psyborg.EventDispacther = EventDispacther;
