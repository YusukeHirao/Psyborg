/**!
* psyborg - v0.12.0
* revision: 3064226e506abb9a7dce11b38b36a3c0291d9f37
* update: 2017-04-14
...
Object.defineProperty(exports, "__esModule", { value: true });
var PsyborgEventDispacther_1 = __webpack_require__(15);
/**
 * Psyborgで取り扱うDOM要素
 *
 * @since 0.9.0
...
Object.defineProperty(exports, "__esModule", { value: true });
var PsyborgElement_1 = __webpack_require__(1);
/**
 * スライドショーコンテナ要素
 *
...
Object.defineProperty(exports, "__esModule", { value: true });
var PsyborgElement_1 = __webpack_require__(1);
var PsyclePanel_1 = __webpack_require__(16);
/**
 * スライドショーパネル要素リスト
 *
 * @since 0.1.0
...
var PsyclePanelList = function (_super) {
    ...
    PsyclePanelList.prototype.remove = function (index, removeFromDOMTree) {
        if (removeFromDOMTree === void 0) {
            removeFromDOMTree = true;
        }
...
var PsycleContainer_1 = __webpack_require__(5);
var PsycleEvent_1 = __webpack_require__(4);
var PsyclePanelList_1 = __webpack_require__(6);
var PsycleReflowTiming_1 = __webpack_require__(0);
var PsycleRepeat_1 = __webpack_require__(3);
var PsycleStage_1 = __webpack_require__(17);
var PsycleTransition_1 = __webpack_require__(2);
/**
 * スライド要素を生成・管理するクラス
 *
 * @since 0.9.1
        ...
        reflow: function (info) {
            ...
            switch (info.timing) {
                ...
                case PsycleReflowTiming_1.default.LOAD:
                    {
                        if (this.config.resizable) {
                            var _a = this.stage.el.getBoundingClientRect(),
                                width = _a.width,
                                height = _a.height;
...
var StyleSheet_1 = __webpack_require__(7);
var Util_1 = __webpack_require__(8);
var Window_1 = __webpack_require__(18);
var PsycleReflowTiming_1 = __webpack_require__(0);
var PsycleRepeat_1 = __webpack_require__(3);
var PsycleTransition_1 = __webpack_require__(2);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Psycle_1 = __webpack_require__(9);
var PsycleEvent_1 = __webpack_require__(4);
var PsycleReflowTiming_1 = __webpack_require__(0);
var PsycleRepeat_1 = __webpack_require__(3);
...
Object.defineProperty(exports, "__esModule", { value: true });
var PsyborgEvent_1 = __webpack_require__(14);
/**
    ...
    PsyborgEventDispacther.prototype.trigger = function (type, data, context) {
        ...
        if (this._listeners[type]) {
            ...
            for (var i = 0; i < l; i++) {
                ...
                var e = new PsyborgEvent_1.default(type);
                e.data = data;
...
exports.default = PsyborgEventDispacther;
