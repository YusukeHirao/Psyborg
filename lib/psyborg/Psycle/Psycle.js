...
var Psycle = /** @class */ (function (_super) {
     ...
     * @return 生成したjQuery要素
     */
    Psycle.prototype.marker = function (options) {
        var _this = this;
        var $ul = $('<ul />');
        // currentClassAddionalEventType引数のデフォルト
        var currentClassAddionalEventType = (options === null || options === void 0 ? void 0 : options.currentClassAddionalEventType) || PsycleEvent_1.default.PANEL_CHANGE_END;
        var accessibleNameFn = options === null || options === void 0 ? void 0 : options.accessibleName;
        for (var i = 0, l = this.length; i < l; i++) {
            var accName = typeof accessibleNameFn === 'function' ? accessibleNameFn(i) : "" + (i + 1);
            var $li = $("<li><button><span>" + accName + "</span></button></li>");
            $li.appendTo($ul);
        ...
        var $lis = $ul.find('li');
        var $buttons = $lis.find('button');
        this.on([PsycleEvent_1.default.INIT, currentClassAddionalEventType].join(' '), function (e) {
        ...
        $buttons.on('click', function (e) {
            ...
            _this.gotoPanel(index, options === null || options === void 0 ? void 0 : options.duration);
            e.preventDefault();
        });
        return $ul;
    };
    ...
    Psycle.prototype.marked = function ($elem, options) {
        ...
        $children.on('click', function (e) {
            _this.gotoPanel($(e.target).index(), config.duration || 0);
            e.preventDefault();
        });
    };
    /**
