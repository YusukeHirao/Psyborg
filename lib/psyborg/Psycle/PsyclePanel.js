...
exports.PsyclePanelClone = void 0;
 ...
 * @param list パネル要素リスト
 */
var PsyclePanel = /** @class */ (function (_super) {
    __extends(PsyclePanel, _super);
    function PsyclePanel($el, index, list, onFocus) {
        ...
        $el.attr('tabindex', 0);
        $el.on('focus', function () { return onFocus && onFocus(index); });
        return _this;
    }
    /**
     * 要素を表示する
 ...
 * @param パネル要素リスト
 */
var PsyclePanelClone = /** @class */ (function (_super) {
    __extends(PsyclePanelClone, _super);
    function PsyclePanelClone($el, index, list) {
        var _this = _super.call(this, $el, index, list, null) || this;
