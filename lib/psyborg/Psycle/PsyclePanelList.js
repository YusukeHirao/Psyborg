...
var PsyclePanelList = /** @class */ (function (_super) {
    ...
    function PsyclePanelList($el, onFocus) {
     ...
     * @return 自身
     */
    PsyclePanelList.prototype.add = function ($el, onFocus) {
        var index = this._panels.length;
        var panel = new PsyclePanel_1.default($el, index, this, onFocus);
